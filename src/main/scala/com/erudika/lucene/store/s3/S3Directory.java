 ...
 * Each "object" has an entry in the S3, and different {@link com.erudika.lucene.store.s3.handler.FileEntryHandler}
	...
	public String[] listAll() {
		...
		try {
			...
			for (ListObjectsV2Response response : responses) {
				names.addAll(response.contents().stream().map(S3Object::key).toList());
			}
		} catch (Exception e) {
